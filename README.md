...
- All 114 regular monster sprites extracted in full color (extract_monster_sprites.py);
  fiends/Chaos via colorize_monster.py
...
- Fiend/Chaos sprites into the main extractor (currently a separate TSA path)
